...
namespace SockDll.Controls 
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		public TaskbarNotifier(int style)
		{
            ...
            {
                case 1:
                    this.SetBackgroundBitmap((System.Drawing.Image)FormAccess.rm.GetObject ("skin"), Color.FromArgb(255, 0, 255));
                    this.SetCloseBitmap((System.Drawing.Image)FormAccess.rm.GetObject("close"), Color.FromArgb(255, 0, 255), new Point(127, 8));
                    this.TitleRectangle = new Rectangle(40, 9, 70, 25);
                    this.ContentRectangle = new Rectangle(8, 41, 133, 68);

                    break;
                case 2:
                    this.SetBackgroundBitmap((System.Drawing.Image)FormAccess.rm.GetObject("skin2"), Color.FromArgb(255, 0, 255));
                    this.SetCloseBitmap((System.Drawing.Image)FormAccess.rm.GetObject("close2"), Color.FromArgb(255, 0, 255), new Point(300, 74));
                    this.TitleRectangle = new Rectangle(123, 80, 176, 16);
                    this.ContentRectangle = new Rectangle(116, 97, 197, 22);

                    break;
                case 3:
                    this.SetBackgroundBitmap((System.Drawing.Image)FormAccess.rm.GetObject("skin3"), Color.FromArgb(255, 0, 255));
                    this.SetCloseBitmap((System.Drawing.Image)FormAccess.rm.GetObject("close"), Color.FromArgb(255, 0, 255), new Point(280, 57));
